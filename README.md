...
- That baseline is often stable but not meaningful when you are comparing headphones/settings. Calibration removes it so you can compare the _extra_ delay from what you are testing.
